import { Raices, check, check2, imagetwo, curveBordo, curveVerde } from "../assets";
import { collabContent, premisas } from "../constants";
    ...
    <Section className="bg-custom lg:mx-10 lg:mb-20" crosses>
      ...
      <div className="container lg:flex">
        ...
        >
          ...
          <motion.button
            className="bg-bordo absolute z-50 text-white px-4 py-2 rounded-lg shadow-md"
