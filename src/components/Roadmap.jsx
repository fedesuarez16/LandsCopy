...
const Roadmap = () => (
  <section id="management" className="overflow-hidden h-auto bg-custom">
    <div className="absolute opacity-30 w-full h-auto"></div>
    <div className="container text-2xl text-center mt-0 mb-20 lg:mt-10 text-bg">
      ...
      <div className="lg:grid lg:grid-cols-2 mx-auto font-code font-thin">
        {/* Primer bloque */}
        <div id="#managementt" className="hidden lg:flex mx-auto h-[160px] bg-gris2 w-[450px] gap-1 items-center justify-center">
        ...
        <div className="hidden lg:flex mx-auto h-[160px] bg-gris2 mb-6 w-[450px] gap-1 items-center justify-center">
          <div className="w-2/4 py-1 px-1 h-full">
        ...
        <div className="lg:hidden mx-auto mb-10">
          <div className="flex flex-col items-center mb-6 bg-gris2 w-48 mx-auto justify-center">
    ...
    <div className="container mb-52 text-center text-bg">
      <p className="text-center text-bg mt-10 text-2xl lg:text-5xl px-4 lg:px-14 font-light">
        Contamos con más de <b>20 años de Experiencia</b> en la <b>Industria Financiera</b> y de <b>Seguros.</b>
      </p>
    </div>
  </section>
);
